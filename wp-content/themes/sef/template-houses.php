    ...
    <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
        <section class="houses" style="margin: 0; padding: 0; max-width: initial">
            <div class="houses__container--upper">
                ...
                <p class="houses__content" data-animation="show-up">En partenariat avec l'asbl "Les Amis de Notre-Dame de la Sarte", le SEF gère depuis 2001 trois petites maisons rue des Vignes à Huy, offrant un accueil et un suivi pour trois familles en logements supervisés. Depuis 2013, une maison de trois appartements située rue de Statte à Huy a également été ajoutée à ce dispositif. Ces deux maisons d'accueil, reconnues par le Ministère de la Région wallonne, offrent un refuge temporaire pour des hommes, des femmes et leurs enfants en situation de grande précarité, leur permettant de se reconstruire sur quelques jours, semaines ou mois.</p>
            </div>
            <?php
            $houses = new WP_Query([
                'post_type' => 'maisons',
