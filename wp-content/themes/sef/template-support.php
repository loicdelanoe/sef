...
<main>
    <section class="support">
        ...
        <p class="support__text" itemprop="description">Afin de nous soutenir vous trouverez différentes possibilités pour nous soutenir.</p>
    </section>
    <section class="material" id="material">
        <h2 class="material__title"><?= get_field('material_title') ?></h2>
        <div class="material__content" data-tag="wysiwyg" itemprop="description">
    ...
    <div class="bg">
        <section class="financial" id="financial">
            ...
            <div class="financial__content" data-tag="wysiwyg" itemprop="description">
    ...
    <section class="volunteer" id="volunteer">
        ...
        <p class="volunteer__text" itemprop="description">Rejoignez notre équipe de bénévoles au SEF de Huy et faites une différence concrète. En donnant un peu de votre temps, vous apportez un soutien précieux et contribuez à une communauté plus solidaire.</p>
